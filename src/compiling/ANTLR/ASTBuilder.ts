...
import { AbstractNode, ClassNode} from "./AbstractNode";
...
import { System_verilog_textContext, Source_textContext, DescriptionContext, Module_nonansi_headerContext, Module_ansi_headerContext, 
    ...
    Delay_controlContext, Event_controlContext, Event_expressionContext, Procedural_timing_controlContext, Jump_statementContext, Wait_statementContext, Event_triggerContext, Disable_statementContext, Conditional_statementContext, Unique_priorityContext, Cond_predicateContext, Case_statementContext, Case_keywordContext, Case_expressionContext, Case_itemContext, Case_pattern_itemContext, Case_inside_itemContext, Case_item_expressionContext, Randcase_statementContext, Randcase_itemContext, Open_range_listContext, Open_value_rangeContext, PatternContext, Assignment_patternContext, Structure_pattern_keyContext, Array_pattern_keyContext, Assignment_pattern_keyContext, Assignment_pattern_expressionContext, Assignment_pattern_expression_typeContext, Constant_assignment_pattern_expressionContext, Assignment_pattern_net_lvalueContext, Assignment_pattern_variable_lvalueContext, Loop_statementContext, For_initializationContext, For_variable_declarationContext, For_stepContext, For_step_assignmentContext, Loop_variablesContext, Subroutine_call_statementContext, Assertion_itemContext, Deferred_immediate_assertion_itemContext, Procedural_assertion_statementContext, Immediate_assertion_statementContext, Simple_immediate_assertion_statementContext, Simple_immediate_assert_statementContext, Simple_immediate_assume_statementContext, Simple_immediate_cover_statementContext, Deferred_immediate_assertion_statementContext, Deferred_immediate_assert_statementContext, Deferred_immediate_assume_statementContext, Deferred_immediate_cover_statementContext, Clocking_declarationContext, Clocking_eventContext, Clocking_itemContext, Default_skewContext, Clocking_directionContext, List_of_clocking_decl_assignContext, Clocking_decl_assignContext, Clocking_skewContext, Clocking_driveContext, Cycle_delayContext, ClockvarContext, Clockvar_expressionContext, Randsequence_statementContext, ProductionContext, Rs_ruleContext, Rs_production_listContext, Weight_specificationContext, Rs_code_blockContext, Rs_prodContext, Production_itemContext, Rs_if_elseContext, Rs_repeatContext, Rs_caseContext, Rs_case_itemContext, Specify_blockContext, Specify_itemContext, Pulsestyle_declarationContext, Showcancelled_declarationContext, Path_declarationContext, Simple_path_declarationContext, Parallel_path_descriptionContext, Full_path_descriptionContext, List_of_path_inputsContext, List_of_path_outputsContext, Specify_input_terminal_descriptorContext, Specify_output_terminal_descriptorContext, Input_identifierContext, Output_identifierContext, Path_delay_valueContext, List_of_path_delay_expressionsContext, T_path_delay_expressionContext, Trise_path_delay_expressionContext, Tfall_path_delay_expressionContext, Tz_path_delay_expressionContext, T01_path_delay_expressionContext, T10_path_delay_expressionContext, T0z_path_delay_expressionContext, Tz1_path_delay_expressionContext, T1z_path_delay_expressionContext, Tz0_path_delay_expressionContext, T0x_path_delay_expressionContext, Tx1_path_delay_expressionContext, T1x_path_delay_expressionContext, Tx0_path_delay_expressionContext, Txz_path_delay_expressionContext, Tzx_path_delay_expressionContext, Path_delay_expressionContext, Edge_sensitive_path_declarationContext, Parallel_edge_sensitive_path_descriptionContext, Full_edge_sensitive_path_descriptionContext, Data_source_expressionContext, Edge_identifierContext, State_dependent_path_declarationContext, Polarity_operatorContext, System_timing_checkContext, Setup_timing_checkContext, Hold_timing_checkContext, Setuphold_timing_checkContext, Recovery_timing_checkContext, Removal_timing_checkContext, Recrem_timing_checkContext, Skew_timing_checkContext, Timeskew_timing_checkContext, Fullskew_timing_checkContext, Period_timing_checkContext, Width_timing_checkContext, Nochange_timing_checkContext, Timecheck_conditionContext, Controlled_reference_eventContext, Data_eventContext, Delayed_dataContext, Delayed_referenceContext, End_edge_offsetContext, Event_based_flagContext, NotifierContext, Reference_eventContext, Remain_active_flagContext, Timestamp_conditionContext, Start_edge_offsetContext, ThresholdContext, Timing_check_limitContext, Timing_check_eventContext, Controlled_timing_check_eventContext, Timing_check_event_controlContext, Specify_terminal_descriptorContext, Edge_control_specifierContext, Edge_descriptorContext, Zero_or_oneContext, Z_or_xContext, Timing_check_conditionContext, Scalar_timing_check_conditionContext, Scalar_constantContext, ConcatenationContext, Constant_concatenationContext, Constant_multiple_concatenationContext, Module_path_concatenationContext, Module_path_multiple_concatenationContext, Multiple_concatenationContext, Streaming_concatenationContext, Stream_operatorContext, Slice_sizeContext, Stream_concatenationContext, Stream_expressionContext, Array_range_expressionContext, Empty_unpacked_array_concatenationContext, Tf_callContext, System_tf_callContext, Subroutine_callContext, Function_subroutine_callContext, List_of_argumentsContext, Method_call_bodyContext, Built_in_method_callContext, Array_manipulation_callContext, Randomize_callContext, Array_method_nameContext, Inc_or_dec_expressionContext, Constant_expressionContext, Constant_mintypmax_expressionContext, Constant_param_expressionContext, Param_expressionContext, Constant_range_expressionContext, Constant_part_select_rangeContext, Constant_rangeContext, Constant_indexed_rangeContext, ExpressionContext, Tagged_union_expressionContext, Value_rangeContext, Mintypmax_expressionContext, Module_path_conditional_expressionContext, Module_path_expressionContext, Module_path_mintypmax_expressionContext, Part_select_rangeContext, Indexed_rangeContext, Genvar_expressionContext, Constant_primaryContext, PrimaryContext, Module_path_primaryContext, Class_qualifierContext, Range_expressionContext, Primary_literalContext, Time_literalContext, Time_unitContext, Implicit_class_handleContext, Bit_selectContext, SelectContext, Nonrange_selectContext, Constant_bit_selectContext, Constant_selectContext, Constant_let_expressionContext, Net_lvalueContext, Variable_lvalueContext, Nonrange_variable_lvalueContext, Unary_operatorContext, Binary_operatorContext, Inc_or_dec_operatorContext, Unary_module_path_operatorContext, Binary_module_path_operatorContext, NumberContext, Integral_numberContext, Decimal_numberContext, Binary_numberContext, Octal_numberContext, Hex_numberContext, SignContext, SizeContext, Non_zero_unsigned_numberContext, Real_numberContext, Fixed_point_numberContext, ExpContext, Unsigned_numberContext, Binary_valueContext, Octal_valueContext, Hex_valueContext, Decimal_baseContext, Binary_baseContext, Octal_baseContext, Hex_baseContext, Non_zero_decimal_digitContext, Decimal_digitContext, Binary_digitContext, Octal_digitContext, Hex_digitContext, X_digitContext, Z_digitContext, Unbased_unsized_literalContext, String_literalContext, Attribute_instanceContext, Attr_specContext, Attr_nameContext, Array_identifierContext, Block_identifierContext, Bin_identifierContext, C_identifierContext, Cell_identifierContext, Checker_identifierContext, Class_identifierContext, Class_variable_identifierContext, Clocking_identifierContext, Config_identifierContext, Const_identifierContext, Constraint_identifierContext, Covergroup_identifierContext, Covergroup_variable_identifierContext, Cover_point_identifierContext, Cross_identifierContext, Dynamic_array_variable_identifierContext, Enum_identifierContext, Formal_identifierContext, Formal_port_identifierContext, Function_identifierContext, Generate_block_identifierContext, Genvar_identifierContext, Hierarchical_array_identifierContext, Hierarchical_block_identifierContext, Hierarchical_event_identifierContext, Hierarchical_identifierContext, Hierarchical_net_identifierContext, Hierarchical_parameter_identifierContext, Hierarchical_property_identifierContext, Hierarchical_sequence_identifierContext, Hierarchical_task_identifierContext, Hierarchical_tf_identifierContext, Hierarchical_variable_identifierContext, IdentifierContext, Index_variable_identifierContext, Interface_identifierContext, Interface_instance_identifierContext, Inout_port_identifierContext, Input_port_identifierContext, Instance_identifierContext, Library_identifierContext, Member_identifierContext, Method_identifierContext, Modport_identifierContext, Module_identifierContext, Net_identifierContext, Net_type_identifierContext, Output_port_identifierContext, Package_identifierContext, Package_scopeContext, Parameter_identifierContext, Port_identifierContext, Production_identifierContext, Program_identifierContext, Property_identifierContext, Ps_class_identifierContext, Ps_covergroup_identifierContext, Ps_checker_identifierContext, Ps_identifierContext, Ps_or_hierarchical_array_identifierContext, Ps_or_hierarchical_net_identifierContext, Ps_or_hierarchical_property_identifierContext, Ps_or_hierarchical_sequence_identifierContext, Ps_or_hierarchical_tf_identifierContext, Ps_parameter_identifierContext, Ps_type_identifierContext, Sequence_identifierContext, Signal_identifierContext, Simple_identifierContext, Specparam_identifierContext, Task_identifierContext, Tf_identifierContext, Terminal_identifierContext, Topmodule_identifierContext, Type_identifierContext, Udp_identifierContext, Variable_identifierContext } from "./grammar/build/SystemVerilogParser";
