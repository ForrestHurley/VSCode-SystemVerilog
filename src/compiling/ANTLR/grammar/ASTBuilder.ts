import { SystemVerilogVisitor } from "./build/SystemVerilogVisitor";
    ...
    traverseChildren(tree : ParseTree) : AbstractNode[] {
        ...
        for(let i = 0; i < tree.childCount; i++){
            ...
            if(absChild.isAbstract()){
                childArray.concat(this.traverseChildren(child));
            } else {
